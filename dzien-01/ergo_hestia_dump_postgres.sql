-- =====================================================
-- ERGO HESTIA - Dump bazy danych do ćwiczeń (PostgreSQL)
...
-- Reset sekwencji po wstawieniu z explicit ID
SELECT setval('klienci_id_seq', (SELECT MAX(id) FROM klienci));
...
-- Reset sekwencji po wstawieniu
SELECT setval('polisy_id_seq', (SELECT MAX(id) FROM polisy));
